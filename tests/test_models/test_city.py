...
class TestCity_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        city = City()
        city.id = "123456"
        city.created_at = city.created_at = date
        citystr = city.__str__()
        self.assertIn("[City] (123456)", citystr)
        self.assertIn("'id': '123456'", citystr)
        self.assertIn("'created_at': " + date.repr, citystr)
        self.assertIn("'updated_at': " + date.repr, citystr)
...
class TestCity_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        ...
        city.my_number = 98
        self.assertEqual("Holberton", city.middle_dict())
    ...
    def test_to_dict_output(self):
        ...
        city = City()
        city.id = "123456"
        city.crested_at = city.updated_at = date
        tdict = {
                'id': '123456'
                '__class__': 'City',
